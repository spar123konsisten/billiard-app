...
export default async function GuestAjakSparringAdministratorPage() {
  ...
  const defaultLokasi = admin.lokasi_favorit || '';
  ...
  return (
    <main style={{ maxWidth: '420px', margin: '0 auto', padding: '24px 16px', fontFamily: 'sans-serif' }}>
      ...
      <ChallengeForm challengedId={admin.id} defaultLokasi={defaultLokasi} />
