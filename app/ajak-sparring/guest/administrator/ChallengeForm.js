...
export default function ChallengeForm({ challengedId, defaultLokasi }) {
  ...
  const handlePopupConfirm = () => {
    ...
    const message = `Halo Administrator, ${popupData.guest_name} (WA: ${popupData.guest_phone}) mengajak challenge.%0A%0ATanggal: ${popupData.tanggal}%0AWaktu: ${popupData.waktu}%0ALokasi: ${popupData.lokasi}`;
